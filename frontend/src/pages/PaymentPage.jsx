        ...
        <div style={{
          ...
          <form onSubmit={handleSubmit} style={{
            ...
            <div>
              ...
              <input
                type="text"
                value={paymentData?.residentName || ''}
                onChange={(e) => setPaymentData({...paymentData, residentName: e.target.value})}
                style={{
                  width: '100%',
                  padding: '12px',
            ...
            <div>
              ...
              <input
                type="text"
                value={paymentData?.propertyAddress || ''}
                onChange={(e) => setPaymentData({...paymentData, propertyAddress: e.target.value})}
                style={{
                  width: '100%',
                  padding: '12px',
                  border: '1px solid #E2E8F0',
            ...
            <div>
              ...
              <select
                value={paymentData?.method || 'bank_transfer'}
