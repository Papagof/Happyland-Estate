    ...
    <div style={{
      ...
      <div style={{ maxWidth: '1000px', margin: '0 auto' }}>
        ...
        <div style={{
          ...
          <p style={{ marginBottom: '20px' }}>
            Situated at Oko-Ado on the Lekki-Epe Expressway, Happyland Estate enjoys excellent accessibility to major business districts, shopping centers, restaurants, and educational institutions. The location provides easy access to the Lagos-Calabar caostal road, Lekki toll gate, VI, and other parts of Lagos.
          </p>
          ...
          <p>
            At Happyland Estate, we believe in building more than just houses - we build communities. Regular community events, neighborhood associations, and active engagement in estate development ensure that every resident is part of a thriving, supportive environment where security is paramount, and quality of life is enhanced.
          </p>
        </div>
      </div>
    </div>
