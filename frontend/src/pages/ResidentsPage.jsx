...
export default function ResidentsPage({ residents, setResidents }) {
    ...
    <div style={{
      ...
      <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
        ...
        <div style={{
          ...
          <form onSubmit={handleAddResident} style={{
            display: 'grid',
          ...
          <div style={{
            ...
            {residents.map(resident => (
              <div key={resident.id} style={{
                ...
                borderRadius: '12px',
                boxShadow: '0 4px 12px rgba(15, 23, 42, 0.06)',
                borderLeft: `4px solid ${resident.type === 'landlord' ? '#2563EB' : '#10B981'}`
              }}>
                <div style={{ marginBottom: '15px' }}>
                  ...
                  <div style={{
                    ...
                    background: resident.type === 'landlord' ? '#2563EB' : '#10B981',
                    color: 'white',
                    padding: '4px 12px',
                    borderRadius: '20px',
                    fontSize: '12px',
        ...
        {residents.length === 0 && (
          <div style={{
            ...
            No residents or landlords added yet. Start by adding one above.
          </div>
        )}
      </div>
    </div>
