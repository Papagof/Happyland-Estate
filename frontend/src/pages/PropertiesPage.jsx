      ...
      <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
        ...
        <div style={{
          ...
          <form onSubmit={handleAddProperty} style={{
            ...
            <input
              ...
              value={propertyForm.streetName}
              onChange={(e) => setPropertyForm({...propertyForm, streetName: e.target.value})}
              style={{
                padding: '12px',
            ...
            <input
              ...
              onChange={(e) => setPropertyForm({...propertyForm, houseNumber: e.target.value})}
              style={{
                padding: '12px',
                border: '1px solid #E2E8F0',
                borderRadius: '8px',
          ...
          <div style={{
            ...
            {properties.map(property => (
              <div key={property.id} style={{
                ...
                <div style={{
                  background: property.type === 'sale' ? '#2563EB' : property.type === 'rent' ? '#10B981' : '#14B8A6',
                  padding: '15px',
                  color: 'white'
                }}>
                  <div style={{
        ...
        {properties.length === 0 && (
          <div style={{
            ...
            No properties listed yet. Start by adding one above.
          </div>
        )}
      </div>
    </div>
